...
def load():
    try:
        ...
        if is_docker:
            ...
            engine = create_engine('postgresql+psycopg2://admin:admin123@postgres:5432/mspr5')
        else:
            # Configuration locale - utilise localhost avec le port mappé
            print("💻 Environnement local détecté")
            engine = create_engine('postgresql+psycopg2://admin:admin123@localhost:15432/mspr5')
        ...
        distant_configs = [
            {
                ...
                'url': 'postgresql+psycopg2://admin:admin123@34.155.198.167:5432/mspr5'
            },
            {
                'name': 'VPS/Cloud (utilisateur postgres)',
                'url': 'postgresql+psycopg2://postgres:admin123@34.155.198.167:5432/mspr5'
            },
            {
                'name': 'VPS/Cloud (mot de passe alternatif)',
                'url': 'postgresql+psycopg2://postgres:password@34.155.198.167:5432/mspr5'
            }
        ]
...
def test_connection():
    ...
    configs = [
        'postgresql+psycopg2://admin:admin123@158.178.196.156:5432/mspr5',
        'postgresql+psycopg2://postgres:admin123@158.178.196.156:5432/mspr5',
        'postgresql+psycopg2://admin:password@158.178.196.156:5432/mspr5'
    ]
